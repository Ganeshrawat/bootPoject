...
import com.project.user.service.config.interceptor.RestInterceptor;
...
public class MyConfig {
    ...
    public RestTemplate restTemplate(){
        ...
        interceptors.add(new RestInterceptor(manager(clientRegistrationRepository,oAuth2AuthorizedClientRepository)));
